<template>
  <div :class="prefix" class="flex-c">
    <div :class="prefix + '-icon'" class="group flex-c" @click="isNodesMapShow = !isNodesMapShow">
      <svg
        t="1714565543756"
        class="icon"
  ...
  <div v-if="isNodesMapShow" ref="nodesMapRef" :class="prefix + '-nodes-map'">
